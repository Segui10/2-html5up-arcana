...
class userDAO {
    ...
    public function obtain_provinces_DAO(){
          ...
          $provincias = simplexml_load_file(RESOURCES.'/1_php_mvc_oo/1_Backend/0_template/1 templates_web_examples/2 html5up-arcana/resources/provinciasypoblaciones.xml');
    ...
    public function obtain_cities_DAO($arrArgument){
          ...
          $xml = simplexml_load_file(RESOURCES.'/1_php_mvc_oo/1_Backend/0_template/1 templates_web_examples/2 html5up-arcana/resources/provinciasypoblaciones.xml');
